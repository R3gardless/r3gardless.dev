...
export const Default: Story = {
  args: {
    ...
    thumbnailUrl: '/api/placeholder/900/400',
    thumbnailAlt: 'Next.js 블로그 개발 가이드',
  },
};
