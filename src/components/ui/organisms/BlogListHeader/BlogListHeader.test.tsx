...
describe('BlogListHeader', () => {
  describe('기본 렌더링', () => {
    it('BlogListHeader가 렌더링된다', () => {
      render(<BlogListHeader />);
    ...
    it('중앙 정렬되어 표시된다', () => {
      const { container } = render(<BlogListHeader />);
  ...
  describe('검색 기능', () => {
    it('검색어 입력 시 변경 이벤트가 발생한다', async () => {
      ...
      render(<BlogListHeader onSearchChange={handleSearchChange} />);
    ...
    it('검색어 입력 후 엔터 키 입력 시 검색 이벤트가 발생한다', async () => {
      ...
      render(<BlogListHeader searchValue="TypeScript" onSearch={handleSearch} />);
    ...
    it('로딩 상태일 때 검색이 비활성화된다', async () => {
      ...
      render(
        <BlogListHeader searchValue="TypeScript" onSearch={handleSearch} isSearchLoading={true} />,
      );
  ...
  describe('검색 결과 표시', () => {
    ...
    it('선택된 카테고리와 태그가 검색 결과에 표시된다', () => {
      ...
      // 카테고리가 선택된 경우
      rerender(<BlogListHeader searchValue="React" selectedCategory="JavaScript" />);
      expect(screen.getByText(/Category:/)).toBeInTheDocument();
      expect(screen.getByText('JavaScript')).toBeInTheDocument();

      // 태그가 선택된 경우
      rerender(<BlogListHeader searchValue="React" selectedTags={['Frontend', 'Web']} />);
  ...
  describe('스타일', () => {
    it('추가 클래스가 적용된다', () => {
      const { container } = render(<BlogListHeader className="test-class" />);
