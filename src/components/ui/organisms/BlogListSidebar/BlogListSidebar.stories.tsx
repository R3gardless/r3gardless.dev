...
const meta = {
  title: 'Components/Organisms/BlogListSidebar',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
BlogListSidebar는 블로그 목록 페이지의 사이드바 영역으로 카테고리와 태그 필터링 기능을 제공합니다.
...
} satisfies Meta<typeof BlogListSidebar>;
...
export const Interactive: Story = {
  ...
  render: () => <InteractiveBlogListSidebar />,
};

// 인터랙티브 예시용 컴포넌트
const InteractiveBlogListSidebar = () => {
