...
import { BlogPostRowList, type SortDirection, type SortOption } from './BlogPostRowList';

const meta: Meta<typeof BlogPostRowList> = {
  title: 'Components/Organisms/BlogPostRowList',
  component: BlogPostRowList,
  parameters: {
    layout: 'padded',
    docs: {
      description: {
        component:
          '블로그 포스트 목록을 행 형태로 표시하고 페이지네이션을 제공하는 organism 컴포넌트입니다.',
      },
    },
  },
  tags: ['autodocs'],
