...
Next.js 기반 정적 블로그입니다. 개인 KB의 Markdown 중 `publish: true` 문서만 빌드 시 export해서 GitHub Pages에 배포합니다.

## 주요 기능

- KB Markdown 기반 콘텐츠 파이프라인
...
로컬에서는 `KB_PATH`로 KB 루트를 지정할 수 있습니다.
...
bun run build:content # KB -> content/public export
